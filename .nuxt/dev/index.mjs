import 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/unenv/runtime/polyfill/fetch.node.mjs';
import { Server } from 'http';
import { tmpdir } from 'os';
import { join } from 'path';
import { mkdirSync } from 'fs';
import { parentPort, threadId } from 'worker_threads';
import { provider, isWindows } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/std-env/dist/index.mjs';
import { toEventHandler, defineEventHandler, handleCacheHeaders, createEvent, createApp, createRouter, lazyEventHandler, eventHandler, useQuery } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/h3/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/ohmyfetch/dist/node.mjs';
import destr from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/destr/dist/index.mjs';
import { createRouter as createRouter$1 } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/radix3/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/unstorage/dist/index.mjs';
import _unstorage_drivers_fs from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/unstorage/dist/drivers/fs.mjs';
import { withQuery, joinURL } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/ufo/dist/index.mjs';
import { createRenderer } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/vue-bundle-renderer/dist/index.mjs';
import devalue from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { snakeCase } from 'file:///home/projects/nuxt-3-sdk-demo-97b1sp/node_modules/scule/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/projects/nuxt-3-sdk-demo-97b1sp/server/assets"}];
...
storage.mount('root', _unstorage_drivers_fs({"driver":"fs","base":"/home/projects/nuxt-3-sdk-demo-97b1sp"}));
storage.mount('src', _unstorage_drivers_fs({"driver":"fs","base":"/home/projects/nuxt-3-sdk-demo-97b1sp/server"}));
storage.mount('build', _unstorage_drivers_fs({"driver":"fs","base":"/home/projects/nuxt-3-sdk-demo-97b1sp/.nuxt"}));
storage.mount('cache', _unstorage_drivers_fs({"driver":"fs","base":"/home/projects/nuxt-3-sdk-demo-97b1sp/.nuxt/cache"}));
...
const _2ec882 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _2ec882, lazy: true, method: undefined },
  { route: '/**', handler: _2ec882, lazy: true, method: undefined }
];
...
const getClientManifest = cachedImport(() => import('/home/projects/nuxt-3-sdk-demo-97b1sp/.nuxt/dist/server/client.manifest.mjs'));
const getSSRApp = !process.env.NUXT_NO_SSR && cachedImport(() => import('/home/projects/nuxt-3-sdk-demo-97b1sp/.nuxt/dist/server/server.mjs'));
